package testcases.poc;

import com.modules.CCIAdmin.page.LoginAdmin;
import com.modules.Commons.LaunchBrowser;
import com.modules.Commons.MyActions;
import com.modules.OrderManagement.page.LoginOrderManagement;
import com.modules.QA.page.LoginQA;
import com.pageobjects.MobileEmulator.QA.E_QAHomePage;
import com.pageobjects.WebBrowser.CCIAdmin.page.AdminHomePage;
import com.pageobjects.WebBrowser.CCIAdmin.page.OrdersPage;
import com.pageobjects.WebBrowser.OrderManagement.page.DetailOrderPage;
import com.pageobjects.WebBrowser.OrderManagement.page.OMHomePage;
import Ultilities.Constants;
import com.pageobjects.WebBrowser.QA.page.*;
...
public class TC_Emulator {
    ...
    public void TC_002_Verify_Rating_and_Review() {
        try {
            ...
            Reporter.log("Start TC_002 on browser " + Constants.Browser + " with Emulator");
            //Close popup promo
            WebElement btn_ClosePopupPromo = E_QAHomePage.btn_ClosePopupPromo(driver);
            if (MyActions.checkDisplayed(btn_ClosePopupPromo)) {
                MyActions.clickObject(btn_ClosePopupPromo);
            ...
            Reporter.log("Step 7: Click on the Rating (Stars). This will navigate the user to Review section", true);
            MyActions.clickObject(ProductDetailPage.img_RatingStars(driver));
            Thread.sleep(500);
            Reporter.log("Verify after click on the Rating (Stars)", true);
            ...
            Reporter.log("Step 9: Click on Write A Review button. User will be navigated to My Review page.", true);
    ...
    public void TC_003_Verify_Create_and_move_Orders() {
        ...
        try {
            ...
            Assert.assertEquals(sOrderNumber_admin, sOrderNumber, "Order number displayed incorrect");
            ...
            Reporter.log("Step 23: Add wait time to wait for order to show up in (MOM) Order Management System", true);
            Thread.sleep(90000);
            ...
            driver.manage().timeouts().implicitlyWait(60, TimeUnit.SECONDS);
            display = MyActions.checkDisplayed(OMHomePage.tbx_Search(driver));
            ...
            OMHomePage.tbx_Search(driver).sendKeys(Keys.CONTROL + "F5");
            MyActions.setTexts(OMHomePage.tbx_Search(driver), sOrderNumber);
            MyActions.clickObject(OMHomePage.btn_Search(driver));
            Thread.sleep(5000);

            //Step 27: Verify the Order #, Product name and Price
            Reporter.log("Step 27: Verify the Order #, Product name and Price", true);
            ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", OMHomePage.table_Items(driver));
            ...
            Reporter.log("Order number on Orders Management displayed correctly.", true);
            ...
            Reporter.log("Product name on Orders Management displayed correctly.", true);
            ...
            Reporter.log("Grand total on Orders Management displayed correctly.", true);
